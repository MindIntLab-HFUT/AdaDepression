#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#### https://github.com/yanweiyue/masrouter/blob/main/MAR/Utils/log.py
...
MAR_ROOT = Path(os.path.realpath(os.path.join(os.path.split(__file__)[0], "../..")))
...
def configure_logging(print_level: str = "INFO", logfile_level: str = "DEBUG", log_name:str = "log.txt") -> None:
    ...
    logger.add(log_name, level=logfile_level)
